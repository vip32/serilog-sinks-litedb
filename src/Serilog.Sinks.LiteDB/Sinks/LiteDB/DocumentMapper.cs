...
//        /// <param name="mapProperties">if set to <c>true</c> [map properties] also to explicit logevent properties.</param>
//        /// <returns></returns>
//        public static BsonDocument MapLogEvent(LogEvent source, IFormatProvider formatProvider, bool mapProperties = true)
//        {
...
//            }
//            if(mapProperties) MapProperties(source, target);
//            return target;
//        }
